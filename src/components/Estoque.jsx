            ...
            {activeTab === 'detalhes' && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm animate-fade-in h-full">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between border-b border-gray-100 pb-1"><span className="text-gray-500">Renavam</span> <span className="font-bold">{selectedCar.renavam}</span></div>
