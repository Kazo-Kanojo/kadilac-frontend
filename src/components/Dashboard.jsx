  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        {/* Seção Inferior: Gráfico (Fictício) e Lista Recente */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="flex justify-between items-center mb-6">
              ...
              <button 
                ...
                className="text-sm text-[#D80000] hover:underline flex items-center gap-1"
              >
                  ...
                  {isLoading ? (
                    ...
                    stats.recentes.map((venda, index) => (
                      <tr key={index} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-4 py-3 text-green-600 font-bold">R$ {Number(venda.valor).toLocaleString('pt-BR')}</td>
                        <td className="px-4 py-3">
                          <span className="bg-green-100 text-green-700 px-2 py-1 rounded-full text-xs font-bold">Concluído</span>
                        </td>
                      </tr>
                    ))
                  )}
          ...
          <div className="bg-[#D80000] text-white p-6 rounded-xl shadow-lg flex flex-col justify-between relative overflow-hidden">
             {/* Efeito de fundo */}
             ...
             <div>
                ...
                <div className="space-y-3">
                  <button 
                    onClick={() => setActiveScreen('estoque')}
                    className="w-full bg-white text-[#D80000] py-3 px-4 rounded-lg font-bold text-sm hover:bg-red-50 transition-colors flex items-center justify-between group"
                  >
                    Novo Veículo
                  ...
                  <button 
                    ...
                    className="w-full bg-red-800 text-white py-3 px-4 rounded-lg font-bold text-sm hover:bg-red-900 transition-colors flex items-center justify-between border border-red-700"
                  >
                    Cadastrar Cliente
                    <ArrowRight size={16}/>
                  </button>
